...
The same formula, applied to `month` + `dayOfMonth` together, resolves the Feb 29/yearly case: non-leap years clamp to Feb 28; the next leap year independently recomputes back to the 29th on its own, with no leap-year tracking required.
